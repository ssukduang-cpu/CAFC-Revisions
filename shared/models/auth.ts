...
// User storage table with admin approval and policy acceptance.
// (IMPORTANT) This table is mandatory for Replit Auth, don't drop it.
export const users = pgTable("users", {
  ...
  // Whether user is an admin (can access /admin panel)
  isAdmin: boolean("is_admin").default(false).notNull(),
  // Timestamp when user accepted the AI use policy
